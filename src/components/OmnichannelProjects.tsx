import { Target, Phone, Share2, TrendingUp, ArrowRight } from 'lucide-react';
...
const projects = [
  {
    ...
    description: '72% Open, 36% Reply Rate',
  ...
  },
  {
    ...
    description: 'Email, SMS, LinkedIn, Phone',
    link: 'https://www.upwork.com/freelancers/madhutarunsaim?referrer_url_path=/nx/search/talent/details/~0103dfcc01ba6b0369/profile&p=1990911937087201280',
    borderColor: 'border-gray-600',
    glowColor: 'shadow-none'
  },
  {
    ...
    description: '5-Day Touch Sequence',
    link: 'https://www.upwork.com/freelancers/madhutarunsaim?referrer_url_path=/nx/search/talent/details/~0103dfcc01ba6b0369/profile&p=1990911937087201280',
    borderColor: 'border-blue-500',
    glowColor: 'shadow-[0_0_30px_rgba(59,130,246,0.4)]'
  }
...
export default function OmnichannelProjects() {
  return (
    <section id="products" className="py-20 px-4 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg font-light">Omnichannel outreach systems we've built</p>
        </div>
